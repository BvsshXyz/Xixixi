...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}                 • BayuXD •                 $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e ""
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
rm -rf /root/NewUpdate
read -p "│  NEW IPVPS : " daftar
echo -e "$COLOR1│${NC}"
echo -e "$COLOR1│${NC}  [INFO] Checking the IPVPS!"
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/NewUpdate/main/regis | awk '{print $4}' | grep $daftar)
...
git clone https://github.com/${USERGIT}/regis.git &> /dev/null
cd /root/regis/ &> /dev/null
rm -rf .git &> /dev/null
git init &> /dev/null
touch ip &> /dev/null
...
Reg Date    : $hariini
" 
echo "${TEXT}" >>/root/regis/newuser 
echo "### $client $exp $daftar $isadmin" >>/root/NewUpdate/regis 
git add .
git commit -m register &> /dev/null
git branch -M ipuk &> /dev/null
git remote add origin https://github.com/${USERGIT}/NewUpdate.git &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/NewUpdate.git &> /dev/null
sleep 1
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
...
function delipvps(){
clear
rm -rf /root/NewUpdate &> /dev/null
git config --global user.email "${EMAILGIT}" &> /dev/null
git config --global user.name "${USERGIT}" &> /dev/null
git clone https://github.com/${USERGIT}/NewUpdate.git &> /dev/null
cd /root/NewUpdate/ &> /dev/null
rm -rf .git &> /dev/null
git init &> /dev/null
touch ip &> /dev/null
clear
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
grep -E "^### " "/root/NewUpdate/regis" | cut -d ' ' -f 2-4 | nl -s '. '
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}                 • BayuXD •                 $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
...
name1=$(grep -E "^### " "/root/NewUpdate/regis" | cut -d ' ' -f 2 | sed -n "$nombor"p) #name
exp=$(grep -E "^### " "/root/NewUpdate/regis" | cut -d ' ' -f 3 | sed -n "$nombor"p) #exp
ivps1=$(grep -E "^### " "/root/NewUpdate/regis" | cut -d ' ' -f 4 | sed -n "$nombor"p) #ip
sed -i "s/### $name1 $exp $ivps1//g" /root/NewUpdate/regis &> /dev/null
...
" 
echo "${TEXTD}" >>/root/NewUpdate/delete_log  &> /dev/null
...
git config --global user.email "${EMAILGIT}" &> /dev/null
git config --global user.name "${USERGIT}" &> /dev/null
git clone https://github.com/${USERGIT}/NewUpdate.git
cd /root/NewUpdate/
rm -rf .git
git init
touch ip
...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/root/NewUpdate/regis")
...
name1=$(grep -E "^### " "/root/NewUpdate/regis" | cut -d ' ' -f 2 | sed -n "${CLIENT_NUMBER}"p) #name
exp=$(grep -E "^### " "/root/NewUpdate/regis" | cut -d ' ' -f 3 | sed -n "${CLIENT_NUMBER}"p) #exp
ivps1=$(grep -E "^### " "/root/NewUpdate/regis" | cut -d ' ' -f 4 | sed -n "${CLIENT_NUMBER}"p) #ip
...
sed -i "s/### $name1 $exp $ivps1/### $name1 $exp4 $ivps1/g" /root/NewUpdate/regis
git add .
git commit -m renew
git branch -M ipuk
git remote add origin https://github.com/${USERGIT}/NewUpdate.git
git push -f https://${APIGIT}@github.com/${USERGIT}/NewUpdate.git
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
grep -E "^### " "/root/NewUpdate/regis" | cut -d ' ' -f 2 | nl -s '. '
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}                 • BayuXD •                 $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
...
Isadmin=$(curl -sS https://raw.githubusercontent.com/BvsshXyz/NewUpdate/main/regis | grep $MYIP | awk '{print $5}')
if [ "$Isadmin" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
