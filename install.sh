...
# https://raw.githubusercontent.com/YogzVpn/izinvps/main/ip 
...
if [ "" = "$PKG_OK" ]; then
  ...
  echo -e "[ ${tyblue}NOTES${NC} ] Notes, Script Mod By BayuXD"
...
echo ""
wget -q https://raw.githubusercontent.com/BvsshXyz/Xixixi/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
echo -e "════════════════════════════════════════" | lolcat
    ...
    echo -e "${red}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
    read -rp "Pilih Angka 1/2 Untuk Install Script  : " dom 
...
sleep 2
clear
wget https://raw.githubusercontent.com/BvsshXyz/Xixixi/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/BvsshXyz/Xixixi/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
echo -e "$green[INFO]$NC Install SET-BR!"
wget https://raw.githubusercontent.com/BvsshXyz/Xixixi/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "$green[INFO]$NC Install WEBSOCKET!"
wget https://raw.githubusercontent.com/BvsshXyz/Xixixi/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget https://raw.githubusercontent.com/BvsshXyz/Xixixi/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget https://raw.githubusercontent.com/BvsshXyz/Xixixi/main/update/update.sh && chmod +x update.sh && ./update.sh
rm -f update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
...
echo " "
echo "=====================-[ AutoScript BayuXD-Tunneling ]-===================="
echo ""
echo "------------------------------------------------------------"
echo ""
echo ""
...
echo ""  | tee -a log-install.txt
echo "   >>> WhatsApp : +6281215360549"  | tee -a log-install.txt
echo "   >>> Telegram : t.me/YSSHstore"  | tee -a log-install.txt
echo ""
echo ""
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script BayuXD-Tunneling  ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
